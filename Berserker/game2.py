...
def slow_text(words):
    words += "\n"
    for char in words:
        time.sleep(random.choice([0.01]))
        sys.stdout.write(char)
        sys.stdout.flush()
    time.sleep(1)
cols, rows = shutil.get_terminal_size()

def slow_text2(words):
    words += "\n"
    for char in words:
        time.sleep(random.choice([0.005]))
        sys.stdout.write(char)
        sys.stdout.flush()
    time.sleep(1)
cols, rows = shutil.get_terminal_size()
print(Fore.YELLOW +"")
slow_text2("___                                           __                  "          .center(cols))
slow_text2("\_ |__    ____ _______  ______  ____ _______ |  | __  ____ _______"           .center(cols))
slow_text2("| __ \ _/ __ \/_  __ \/  ___/_/ __ \/_  __ \|  |/ /_/ __ \/_  __ \ "            .center(cols))
slow_text2("| \_\ \/  ___/ |  | \/\___ \ \  ___/ |  | \/|    < \  ___/ |  | \/ "          .center(cols))
slow_text2("|___  / \___  >|__|  /____  > \___  >|__|   |__|_ \ \___  >|__|  "       .center(cols))
slow_text2("\/      \/            \/      \/             \/     \/     \/ "         .center(cols))
print("                                                             ")
print("                                                             ")
print("                                                             ")
language = ["English" , "Persian" , "Ukrainian", "French"]
choice_your_language = input("Enter your language please (English, Persian, Ukrainian, French ) : ")

if choice_your_language == "English":
...
if choice_your_language == "Persian":
#the "Fore" is the colour you wish to put the link of code at, it will also do the rest of the code under it so you need to section this.
    print(Fore.GREEN +"")
    slow_text(".....................  <  <  GAME LOADING  >  >  ......................".center(cols))
...
if choice_your_language == "French":
#the "Fore" is the colour you wish to put the link of code at, it will also do the rest of the code under it so you need to section this.
    print(Fore.GREEN +"")
    slow_text(".....................  <  <  GAME LOADING  >  >  ......................".center(cols))
...
if choice_your_language == "Ukrainian":
#the "Fore" is the colour you wish to put the link of code at, it will also do the rest of the code under it so you need to section this.
    print(Fore.GREEN +"")
    slow_text(".....................  <  <  GAME LOADING  >  >  ......................".center(cols))
